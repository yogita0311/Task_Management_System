...
$query = "select name, email, password from admin where email = '$_POST[email]' AND password = '$_POST[password]'";
        ...
        <div class="col-11 col-sm-8 col-md-6 col-lg-4">
            ...
            <div class="form-box" id="login">
                ...
                <form action="" method="post">
                    ...
                    <button name="adminLogin" class="btn btn-success w-100">Login</button>
